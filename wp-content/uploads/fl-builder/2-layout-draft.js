...
else{module.addClass('fl-animated');}}};$(function(){FLBuilderLayout.init();});})(jQuery);var wpAjaxUrl='http://localhost/lawyersite/wp-admin/admin-ajax.php';var flBuilderUrl='http://localhost/lawyersite/wp-content/plugins/beaver-builder-lite-version/';;if(typeof FLBuilder!=='undefined'&&typeof FLBuilder._renderLayoutComplete!=='undefined')FLBuilder._renderLayoutComplete();